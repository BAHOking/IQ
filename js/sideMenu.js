...
let sideTestLink = document.querySelector(".side-menu__link:nth-child(3)");
...
sideTestLink.addEventListener("click", function showHideSideMenuSideTestLink() {
  if (testStart === true) {
    alert("Ви вже проходите тест.");
